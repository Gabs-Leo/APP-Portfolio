...
import comingSoonImage from "./../../images/shuraig.jpg"
    ...
    <section className="container" id="projects" style={{padding: `40px 10px`}} >
        ...
        <div className="galleryProject" style={{paddingBottom: `60px`}}>
            <div className="projectTwo" style={{position: `relative`}}>
                <div data-aos-mirror="true" data-aos="fade-down-right" data-aos-duration="1400" className="projectElement" style={{backgroundImage: `url(${longProjects[0]?.image || comingSoonImage})`}}>
                ...
                <div data-aos-mirror="true" data-aos="fade-down-left" data-aos-duration="1400" className="projectElement" style={{backgroundImage: `url(${longProjects[1]?.image || comingSoonImage})`}}>
            ...
            <div className="projectThree mt-4">
                <div data-aos-mirror="true" data-aos="fade-up-right" data-aos-duration="1400" key={smallProjects[0]?.id || 0} className="projectElement" style={{backgroundImage: `url(${smallProjects[0]?.image || comingSoonImage})`}}>
                    <div className="hoverDetails">
                        <div className="hoverContent">
                            <div>
                ...
                <div data-aos-mirror="true" data-aos="fade-up" data-aos-duration="1400"  key={smallProjects[1]?.id || 1} className="projectElement" style={{backgroundImage: `url(${smallProjects[1]?.image || comingSoonImage})`}}>
                    <div className="hoverDetails">
                        <div className="hoverContent">
                            <div>
                ...
                <div data-aos-mirror="true" data-aos="fade-up-left" data-aos-duration="1400" key={smallProjects[2]?.id || 2} className="projectElement" style={{backgroundImage: `url(${smallProjects[2]?.image || comingSoonImage})`}}>
                    <div className="hoverDetails">
                        <div className="hoverContent">
                            <div>
